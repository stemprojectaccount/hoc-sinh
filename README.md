        ...
        * {
        ...
        .parallax-bg {
            ...
            background-image: 
                ...
                radial-gradient(circle at 80% 20%, rgba(255, 203, 112, 0.3) 0%, transparent 50%),
        ...
        function showStudentPage(year) {
            ...
            for (let i = 1; i <= 5; i++) {
                ...
                studentCard.innerHTML = `
                    ...
                    <img src="https://via.placeholder.com/140x140/3a6dc9/FFFFFF?text=HS+${i}" alt="Học sinh ${i}" class="student-image image-3d">
                    <h3>Học sinh ${i}</h3>
        ...
        function showMastersPhdPage() {
            ...
            graduates.forEach((graduate, index) => {
                ...
                graduateCard.innerHTML = `
                    ...
                    <img src="https://via.placeholder.com/160x160/FF8C42/FFFFFF?text=${graduate.name.split(' ').pop()}" alt="${graduate.name}" class="graduate-image image-3d">
